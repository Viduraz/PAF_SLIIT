    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
        {plan.image ? (
          ...
          <div className="h-64 md:h-80 w-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="mb-8">
            ...
            {(plan.milestones || []).length > 3 && (
              <button 
                className="mt-4 flex items-center text-green-600 hover:text-green-800 font-medium"
