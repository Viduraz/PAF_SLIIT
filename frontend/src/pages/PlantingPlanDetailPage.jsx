...
function PlantingPlanDetailPage() {
  ...
  if (!plan) {
    return <div className="alert alert-warning mt-3">Planting plan not found</div>;
  }
            ...
            <div className="card-body">
              ...
              {isAuthenticated ? (
                ...
                <div className="alert alert-info">
                  <Link to="/login">Login</Link> or <Link to="/register">Register</Link> to track your progress with this planting plan
                </div>
              )}
            </div>
          </div>
